...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between gap-3 py-4 text-left text-base font-medium text-text-primary transition-all hover:text-accent focus-visible:outline-none focus-visible:text-accent [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
